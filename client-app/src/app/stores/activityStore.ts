...
export default class ActivityStore {
    ...
    updateActivity = async (activity: ActivityFormValues) => {
        ...
        try {
            ...
            runInAction(() => {
                if (activity.id) {
                    const updatedAcitivity = { ... this.getActivity(activity.id), ...activity };
                    this.activityRegistry.set(activity.id, updatedAcitivity as Activity);
                    this.selectedActivity = updatedAcitivity as Activity;
                }
